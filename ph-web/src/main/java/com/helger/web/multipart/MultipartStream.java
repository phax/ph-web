...
public class MultipartStream
{
  ...
  /**
   * The maximum length of <code>header-part</code> that will be processed (20 kilobytes = 10240
   * bytes.).
   */
   ...
   * (see {@link #MultipartStream(InputStream, byte[], int, MultipartProgressNotifier)} ).
   *
