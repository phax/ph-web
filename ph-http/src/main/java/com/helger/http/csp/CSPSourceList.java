...
public class CSPSourceList
{
   ...
   */
  @Nonnull
  public CSPSourceList addMimeType (@Nonnull final IMimeType aMimeType)
  {
   ...
   */
  @Nonnull
  public CSPSourceList addKeywordNone ()
  {
   ...
   */
  @Nonnull
  public CSPSourceList addNonce (@Nonnull @Nonempty final byte [] aNonceValue)
  {
   ...
   */
  @Nonnull
  public CSPSourceList addNonce (@Nonnull @Nonempty final String sNonceBase64Value)
  {
   ...
   */
  @Nonnull
  public CSPSourceList addHash (@Nonnull final EMessageDigestAlgorithm eMDAlgo,
   ...
   */
  @Nonnull
  public CSPSourceList addHash (@Nonnull final EMessageDigestAlgorithm eMDAlgo, @Nonnull final String sHashBase64Value)
  {
