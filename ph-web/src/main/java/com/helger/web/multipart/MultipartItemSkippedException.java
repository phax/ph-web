...
/**
 * This exception is thrown, if an attempt is made to read data from the {@link InputStream}, which
 * has been returned by {@link IFileItemStream#openStream()}, after
 * {@link java.util.Iterator#hasNext()} has been invoked on the iterator, which created the
 * {@link IFileItemStream}.
 */
