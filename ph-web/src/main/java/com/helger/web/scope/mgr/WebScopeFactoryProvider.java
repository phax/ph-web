 ...
 */
@NotThreadSafe
public final class WebScopeFactoryProvider
{
  @PresentForCodeCoverage
  private static final WebScopeFactoryProvider s_aInstance = new WebScopeFactoryProvider ();

  private static IWebScopeFactory s_aWebScopeFactory = new DefaultWebScopeFactory ();

  private WebScopeFactoryProvider ()
  {}
